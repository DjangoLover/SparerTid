...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'account_user', (
            ...
            ('jid', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=100, db_index=True)),
    ...
    models = {
        u'account.user': {
            ...
            'jid': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
